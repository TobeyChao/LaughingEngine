...
void ShaderProgram::ParseFromMemory(ShaderType type, Utility::ByteArray bytes)
{
	...
	cout << "Version: " << VersionStr + MajorVersionStr + MinorVersionStr << endl;

	// 着色器创建者的名称
	cout << "Creator: " << shader_desc.Creator << endl;
	...
	for (UINT i = 0; i < shader_desc.InputParameters; ++i)
	{
		...
		cout << "IN D3D12_SIGNATURE_PARAMETER_DESC At Index "
			<< i
			<< " : "
			<< signature_parameter_desc.SemanticName
			<< " - "
			<< signature_parameter_desc.SemanticIndex
			<< " - "
			<< (UINT)signature_parameter_desc.Mask
			<< endl;
	...
	for (UINT i = 0; i < shader_desc.OutputParameters; ++i)
	{
		...
		cout << "OUT D3D12_SIGNATURE_PARAMETER_DESC At Index "
			<< i
			<< " : "
			<< signature_parameter_desc.SemanticName
			<< " - "
			<< signature_parameter_desc.SemanticIndex
			<< " - "
			<< signature_parameter_desc.Register
			<< endl;
	}
...
void ShaderProgram::OutputBoundResources(UINT i, const D3D12_SHADER_INPUT_BIND_DESC& shader_input_bind_desc)
{
	cout << "Bound Resources At Index "
		<< i
		<< " Name:"
		<< shader_input_bind_desc.Name
		<< " Type:"
		<< shader_input_bind_desc.Type
		<< " BindPoint:"
		<< shader_input_bind_desc.BindPoint
		<< " BindCount:"
		<< shader_input_bind_desc.BindCount
		<< " Dimension:"
		<< shader_input_bind_desc.Dimension
		<< " Space:"
...
void ShaderProgram::OutputVariable(UINT j, ID3D12ShaderReflectionVariable* variable)
{
	...
	cout << "Var At "
		<< j
		<< " Name: "
		<< shader_var_desc.Name
		<< " Offset: "
		<< shader_var_desc.StartOffset
		<< " Size: "
		<< shader_var_desc.Size
		<< " TypeName: "
		<< shader_type_desc.Name
		<< " Members: "
		<< shader_type_desc.Members
		<< " Elements: "
		<< shader_type_desc.Elements
		<< " Offset: "
		<< shader_type_desc.Offset
		<< endl;
...
void ShaderProgram::OutputType(ID3D12ShaderReflectionType* type)
{
	...
	for (UINT x = 0; x < shader_type_desc.Members; ++x)
	{
		...
		cout << "Member At "
			<< x
			<< " Name:"
			<< type->GetMemberTypeName(x)
			<< " TypeName: "
			<< member_type_desc.Name
			<< " Members: "
			<< member_type_desc.Members
			<< " Elements: "
